...
* [x] Updated the timeline view to show likes. 
* [x] You can reply to tweets from the timeline view itself.
* [x] Added divider between the recycler view articles.
* [x] Added twitter logo to the timeline view.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/9Tp3aR0.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
## License
    ...
    Copyright [2016] [Manisha Roy Choudhury]
