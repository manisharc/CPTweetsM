...
* [x] Made the toolbar collapsible in the UserProfileView, similar to Twitter.
* [x] The user's profile image shows up on the tool bar

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/lWTTMyFJ.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
